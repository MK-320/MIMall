...
import * as api from './api'  // 导入 src/api/index.js 导出的所有模块
Vue.prototype.$api = api;      // 挂载到Vue原型，所有组件可用 this.$api
...
//mock开关，这里这么写是因为 ，如果直接在main.js中import 导入，
// 那么由于是预编译的，所以每次发请求都会被mockjs拦截，但是我们不想要这么做，只有需要时才开启mock
const mock =false ;
if(mock){
